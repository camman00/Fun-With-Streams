...
public class FunWithStreamsTest {
	...
	// assertEquals(Arrays.asList(new String[] { "1", "2", "3", "4", "10", "12" }),
	...
	// @Test
	// public void testSum() {
	// assertEquals(Optional.of(32), FunWithStreams.sum(testNumbers));
	// assertEquals(Optional.empty(), FunWithStreams.sum(testEmpty));
	// }
	//
	// @Test
	// public void testSumFormula() {
	// System.out.println("\nTesting sum formula with 1, 2, 3, 4, 10, 12 (not
	// parallel):");
	...
	// System.out.println("\nTesting sum formula with 1, 2, 3, 4, 10, 12
	// (parallel):");
	...
	// assertEquals(Arrays.asList(new Integer[] { 2, 4, 10, 12 }),
	// list(FunWithStreams.evens(testNumbers.parallel())));
	// assertEquals(new ArrayList<String>(), list(FunWithStreams.evens(testEmpty)));
	// }
	//
	// @Test
	// public void testDeductFromFirst() {
	// assertEquals(Optional.of(-30), FunWithStreams.deductFromFirst(testNumbers));
	// assertEquals(Optional.empty(), FunWithStreams.deductFromFirst(testEmpty));
	// }
	//
	// @Test
